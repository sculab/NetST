...
NetST (Network for Sequences and Traits): https://github.com/yyscu/NetST
...
![image-20230820150248051](https://github.com/yyscu/NetST/blob/master/main/screen.png)
...
NetST-GUI是编译好的版本，用户可直接从[https://github.com/yyscu/NetST/releases](https://github.com/yyscu/NetST/releases)中下载并直接使用。
...
[教程1: 构建单倍型网络](https://github.com/yyscu/NetST/blob/master/examples/ZH_CN/class1.md)

[教程2: 序列分型](https://github.com/yyscu/NetST/blob/master/examples/ZH_CN/class2.md)
