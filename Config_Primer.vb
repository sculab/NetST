...
Public Class Config_Primer
    Private Sub Config_Primer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub But1()
        ...
        startInfo.Arguments = "-input " + """" + target_file + """" + " -max_primer " + NumericUpDown1.Value.ToString
        ...
        startInfo.Arguments += " -min_marker_length " + NumericUpDown6.Value.ToString + " -max_marker_length " + NumericUpDown5.Value.ToString
        startInfo.Arguments += " -gap_length " + NumericUpDown7.Value.ToString + " -t " + NumericUpDown8.Value.ToString
        startInfo.Arguments += " -usevar " + CheckBox1.Checked.ToString
    ...
    Private Sub Config_Primer_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        If data_type = "gb" Then
            Label4.Visible = True
