  ...
  function getLayout(style, groups, haplotypes) {
    $('#layout').w2layout({
      ...
      panels: [
        ...
        {
          type: 'left', size: 250, maxSize: 350, resizable: true, title: 'Data', style: style,
          tabs: {
            name: 'tabs',
            active: 'tab1',
            tabs: [
        ...
        { type: 'right', size: 140, resizable: false, title: 'Settings', style: style },
        {
          ...
          toolbar: {
            items: [
              ...
              {
                id: 'btn-time', type: 'menu', text: 'Center', icon: 'icon-circles-2', disabled: true,
                items: [
                  { text: 'Gray', typeid: "0" },
                  { text: 'Red', typeid: "1" },
                  { text: 'Green', typeid: "2" },
  ...
  */
  ...
  if (window.File && window.FileReader && window.FileList && window.Blob) {
    ...
    layout.html('right',
      ...
      '<div class="w2ui-field"><label>Distance:</label><div><input type="text" id="linkDistance" /></div></div>' +
      '<div class="w2ui-field"><label>Strength:</label><div><input type="text" id="linkStrength"  /></div></div>' +
