Module Module_Language
    Public Sub to_en()
        ...
        form_main.网络图可视化ToolStripMenuItem.Text = "Haplotype Network Analysis"
        form_main.拓扑结构分析ToolStripMenuItem.Text = "Network Topology Analysis"
        form_main.社区检测ToolStripMenuItem.Text = "Community Analysis"
        form_main.模块度分析ToolStripMenuItem.Text = "Modularity Analysis"
    ...
    Public Sub to_ch()
        ...
        form_main.网络图可视化ToolStripMenuItem.Text = "单倍型网络分析"
        form_main.拓扑结构分析ToolStripMenuItem.Text = "拓扑结构分析"
        form_main.社区检测ToolStripMenuItem.Text = "社区检测分析"
        form_main.模块度分析ToolStripMenuItem.Text = "模块度分析"
