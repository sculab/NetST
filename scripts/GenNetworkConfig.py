...
# python GenNetworkConfig.py GenNetworkConfig_Test/test.gml GenNetworkConfig_Test/test.json GenNetworkConfig_Test/test.meta GenNetworkConfig_Test/test
# dist\all\GenNetworkConfig.exe GenNetworkConfig_Test/test.gml GenNetworkConfig_Test/test.json GenNetworkConfig_Test/test.meta GenNetworkConfig_Test/test
...
def main():
    args = sys.argv
    if len(args) != 5:
        sys.stderr.write("usage: python GetNetworkConfig.py <in.gml> <in.json> <in.meta> <out_prefix>\n")
        sys.exit(-1)
    gml_file = args[1]
    json_file = args[2]
    meta_file = args[3]
